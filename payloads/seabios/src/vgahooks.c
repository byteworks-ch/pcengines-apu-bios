...
#if CONFIG_LVDS_800
/* This is the EDID table for a 800x600 LVDS panel */
const u8 edid_800x600[] VARFSEG = {
       0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00,
       0x04, 0x21, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
       0x01, 0x00, 0x01, 0x03, 0x00, 0x00, 0x00, 0x00,
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
       0x00, 0x00, 0x00, 0x3f, 0xc0, 0x00, 0x01, 0x01,
...
#if CONFIG_LVDS_640
/* This is the EDID table created for a 640x480 panel */
const u8 edid_640x480[] VARFSEG = {            // CSUM
       0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, // 05fa
       0x04, 0x21, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0025
       0x01, 0x00, 0x01, 0x03, 0x00, 0x00, 0x00, 0x00, // 0005
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0000
       0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x01, 0x01, // 0022
       0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, // 0008
       0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0xd8, 0x09, // 00e7
       0x80, 0xa0, 0x20, 0xe0, 0x2d, 0x10, 0x10, 0x60, // 02cd
       0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0014
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0000
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0000
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0000
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0000
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0000
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0000
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xea  // 0A16+EA=B00
};
#endif

// INT15.4E08 callback for LVDS panel EDID
void handle_154e(struct bregs *regs)
{
    dprintf(1, "INT15.4E08 - ");

    if ( ((regs->ax)==0x4e08) && (((regs->bx) & 0x00ff)==0x1b) ) {
#if CONFIG_LVDS_800
        dprintf(1, "Retrieving 800x600 LCD Panel EDID\n");
        regs->cx = sizeof(edid_800x600);
        regs->di = (u32)edid_800x600;
        regs->al = 0; /* success */
        return;
#endif
#if CONFIG_LVDS_640
        dprintf(1, "Retrieving 640x480 LCD Panel EDID\n");
        regs->cx = sizeof(edid_640x480);
        regs->di = (u32)edid_640x480;
        regs->al = 0; /* success */
        return;
#endif
	}
