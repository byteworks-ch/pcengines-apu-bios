...
struct bootorder_container {
	...
	u32  bootorder_size;          /* Actual total size of this structure */
	char bootorder_file_name[16]; /* file name in CBFS */
	char bootorder_data[0];       /* Variable size, run time dependent. */
