...
static struct hw_mem_hole_info get_hw_mem_hole_info(void)
{
	 ...
	 * are not continuous instead of hole, it will find out it's hole_startk
	 */
...
static void setup_uma_memory(void)
{
	...
	/* If the UMA size is configurable and is set to 64MB, 256MB, or 384MB
	 * override the uma_memory_size calculation made above.
	 */
#if	(!CONFIG_GFXUMA_MODE_AUTO)
	uma_memory_size = CONFIG_GFXUMA_SIZE << 16;
#endif
