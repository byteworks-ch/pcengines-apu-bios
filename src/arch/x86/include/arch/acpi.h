...
typedef struct acpi_spcr {
	...
	u8  reserved_2;
	u8  reserved_3;
	struct acpi_gen_regaddr base_address;
	u8  interrupt_type;
	u8  irq;
...
#define ACPI_SPCR_REV						1

#define SPCR_16550_INTERFACE				0
#define SPCR_16450_INTERFACE				1

#define SPCR_RESERVED_MUST_BE_ZERO			0

#define SPCR_NO_INTERRUPT_SUPPORTED			0
#define SPCR_PIC_INTERRUPT_SUPPORTED		(1 << 0)
#define SPCR_APIC_INTERRUPT_SUPPORTED		(1 << 1)
#define SPCR_SAPIC_INTERRUPT_SUPPORTED		(1 << 2)

#define SPCR_NO_IRQ							0
#define SPCR_NO_GSI							0

#define SPCR_9600_BAUD						3
#define SPCR_19200_BAUD						4
#define SPCR_57600_BAUD						6
#define SPCR_115200_BAUD					7

#define SPCR_NO_PARITY						0

#define SPCR_1_STOP_BIT						1

#define SPCR_NO_FLOW_CONTROL				0
#define SPCR_DCD_FLOW_CONTROL				(1 << 0)
#define SPCR_RTS_CTS_FLOW_CONTROL			(1 << 1)
#define SPCR_XON_XOFF_FLOW_CONTROL			(1 << 2)

#define SPCR_TERM_VT100						0
#define SPCR_TERM_VT100_PLUS				1
#define SPCR_TERM_VT_UTF8					2
#define SPCR_TERM_ANSI						3

#define SPCR_DID_NOT_A_PCI_DEVICE			0xffff
#define SPCR_VID_NOT_A_PCI_DEVICE			0xffff
#define SPCR_BUS_NOT_A_PCI_DEVICE			0x00
#define SPCR_DEV_NOT_A_PCI_DEVICE			0x00
#define SPCR_FUNC_NOT_A_PCI_DEVICE			0x00
#define SPCR_PCI_FLAG_NOT_A_PCI_DEVICE		0x00
#define SPCR_PCI_FLAG_NONE					0x00
#define SPCR_PCI_FLAG_DO_NOT_SUPRESS_PNP_ENUM	(1 << 0)
#define SPCR_PCI_SEGMENT_0					0x00
