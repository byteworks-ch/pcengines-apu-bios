...
#if IS_ENABLED(CONFIG_DRIVERS_OXFORD_OXPCIE)
/*
...
#elif IS_ENABLED(CONFIG_CONSOLE_SERIAL8250)
/*
...
#if IS_ENABLED(CONFIG_CONSOLE_SERIAL_COM1)
#define SPCR_IRQ 4
#elif IS_ENABLED(CONFIG_CONSOLE_SERIAL_COM2)
#define SPCR_IRQ 3
#elif IS_ENABLED(CONFIG_CONSOLE_SERIAL_COM3)
#define SPCR_IRQ 4
#elif IS_ENABLED(CONFIG_CONSOLE_SERIAL_COM4)
#define SPCR_IRQ 3
#else
